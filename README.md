...
*EXTERNALApi* | [**get_hardware_presets_hardware_presets_get**](docs/EXTERNALApi.md#get_hardware_presets_hardware_presets_get) | **GET** /hardware-presets | Get Hardware Presets
