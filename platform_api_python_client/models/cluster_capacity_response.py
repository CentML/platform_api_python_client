...
class ClusterCapacityResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cluster_id", "cluster_name", "gpu_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gpu_types": [GpuTypeCapacity.from_dict(_item) for _item in obj["gpu_types"]] if obj.get("gpu_types") is not None else None
        })
        return _obj
