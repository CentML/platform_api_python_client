...
class IstioCniSubchartOverrides(BaseModel):
    """
    IstioCniSubchartOverrides
    """ # noqa: E501
    cni: Optional[IstioCniOverrides] = None
    __properties: ClassVar[List[str]] = ["cni"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cni (nullable) is None
        # and model_fields_set contains the field
        if self.cni is None and "cni" in self.model_fields_set:
            _dict['cni'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cni": IstioCniOverrides.from_dict(obj["cni"]) if obj.get("cni") is not None else None
        })
        return _obj
