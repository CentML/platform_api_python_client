...
class ListClusterCapacityResponse(BaseModel):
    """
    All accessible clusters' GPU capacity, returned by ``GET /capacity``.
    """ # noqa: E501
    results: List[ClusterCapacityResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ClusterCapacityResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
