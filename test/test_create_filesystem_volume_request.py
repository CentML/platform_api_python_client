...
class TestCreateFilesystemVolumeRequest(unittest.TestCase):
    """CreateFilesystemVolumeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFilesystemVolumeRequest:
        """Test CreateFilesystemVolumeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFilesystemVolumeRequest`
        """
        model = CreateFilesystemVolumeRequest()
        if include_optional:
            return CreateFilesystemVolumeRequest(
    ...
    def testCreateFilesystemVolumeRequest(self):
        """Test CreateFilesystemVolumeRequest"""
